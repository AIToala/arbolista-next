...
const DashboardIndexPage = () => {
  return (
    <div style={{ display: 'flex' }}>
      <SidebarC />
      <div style={{ flex: 1, marginLeft: '20px', marginTop:'100px', marginRight:'50px', marginBottom:'100px' }}>
        <Tabs.Group
        ...
        >
          <div className="flex max-w-md flex-col gap-4">
            ...
            <div>
              <div className="mb-2 block">
                <Label
                  htmlFor="nombrescomunes"
                  value="Nombres Comunes"
                />
              </div>
              <TextInput
                id="nombrescomunes"
        ...
        >
          <div className="flex max-w-md flex-col gap-4">
            <div>
              <div className="mb-2 block">
                <Label
                  htmlFor="leaf_attributes"
                  value="Atributos Foliares"
                />
              </div>
              <Textarea
                id="leaf_attributes"
          ...
          <div className="flex max-w-md flex-col gap-4">
            ...
            >
              ...
              >
                ...
                <option>
                  Separador de arterias principales
                </option>
                <option>
                  Vías peatonales
                </option>
            ...
            <div>
              <div className="mb-2 block">
                <Label
                  htmlFor="fruit_limitations"
                  value="Limitacion fruto"
                />
              </div>
              <TextInput

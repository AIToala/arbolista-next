  ...
  return (
    <div className="w-full relative justify-center items-center flex flex-col mx-4">
      <div className="grid grid-cols-1 md:p-2 md:grid-cols-2 justify-center p-6 gap-6">
        ...
        />
        <div className="col-span-1 w-full text-center justify-center p-2">
          <h1 className="font-bold text-2xl">{data[0].name}</h1>
          <h2 className="text-gray-700 font-light">
            {data[0]?.taxonomy.common_names}
          </h2>
          <div>
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="taxonomia">
                <AccordionTrigger className="text-xl text-green-600">
                  Taxonomia
                </AccordionTrigger>
                <AccordionContent>
                  {taxonomy !== null ? (
                    <div className="w-full grid grid-cols-1 gap-4 justify-center items-center !m-0">
                      ...
                      <div className="w-full flex flex-column items-center gap-6">
                        <p className="w-[40%] font-semibold">Genero</p>
                        <p className="w-full text-gray-700 font-light">
                          {taxonomy.genus}
                        </p>
                      </div>
                      ...
                      <div className="w-full flex flex-column items-center gap-6">
                        <p className="w-[40%] font-semibold">Sinonimos</p>
                        <p className="w-full text-gray-700 font-light">
                      ...
                      <div className="w-full flex flex-column items-center gap-6">
                        <p className="w-[40%] font-semibold">Etimologia</p>
                        <p className="w-full text-gray-700 font-light">
                          {taxonomy.etymology}
                        </p>
                      </div>
                      ...
                      <div className="w-full flex flex-column items-center gap-6">
                        <p className="w-[40%] font-semibold">Bibliografia</p>
                        <p className="w-full text-gray-700 font-light">
                          {taxonomy.bibliography.length !== 0 ? (
                            <ul className="list-disc list-inside">
                              {taxonomy.bibliography.map(
                                (bibliography: any) => (
                                  <li key={bibliography}>

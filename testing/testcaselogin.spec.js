...
describe('test-case-login', function() {
  ...
  it('test-case-login', async function() {
    ...
    await driver.sleep(2000);
    await driver.findElement(By.css("#user-menu-button > .rounded-full")).click()
    assert(await driver.findElement(By.css(".px-4 > .text-gray-900")).getText() == "SuperAdmin")
    assert(await driver.findElement(By.css(".truncate")).getText() == "sadmin@arbolista.com")
  })
})
